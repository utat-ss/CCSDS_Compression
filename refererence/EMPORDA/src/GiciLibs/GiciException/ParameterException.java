...
/**
 * This class is an exception for parameter programs. It's useful to diferenciate it from other class of exception.<br>
 *
...
public class ParameterException extends Exception{
	...
	/**
	 * Constructor with error code and message. The message will be passed through Exception class.
	 *
	 * @param message an string that contains the message exception
